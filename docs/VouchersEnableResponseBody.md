...
|**createdAt** | **OffsetDateTime** | Timestamp representing the date and time when the voucher was created in ISO 8601 format. |  [optional] |
...
|**_object** | **String** | The type of object represented by JSON. Default is &#x60;voucher&#x60;. |  [optional] |
