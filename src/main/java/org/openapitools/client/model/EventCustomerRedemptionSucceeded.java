...
public class EventCustomerRedemptionSucceeded {
  ...
  public EventCustomerRedemptionSucceeded() {
  }

  public EventCustomerRedemptionSucceeded customer(SimpleCustomer customer) {
  ...
  **/
  ...
  public EventCustomerRedemptionSucceeded order(SimpleOrder order) {
  ...
  **/
  ...
  public EventCustomerRedemptionSucceeded campaign(SimpleCampaign campaign) {
  ...
  **/
  ...
  public EventCustomerRedemptionSucceeded voucher(SimpleVoucher voucher) {
  ...
  **/
  ...
  public EventCustomerRedemptionSucceeded holder(SimpleCustomer holder) {
  ...
  **/
  ...
  public EventCustomerRedemptionSucceeded promotionTier(SimplePromotionTier promotionTier) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EventCustomerRedemptionSucceeded eventCustomerRedemptionSucceeded = (EventCustomerRedemptionSucceeded) o;
    return Objects.equals(this.customer, eventCustomerRedemptionSucceeded.customer) &&
        Objects.equals(this.order, eventCustomerRedemptionSucceeded.order) &&
        Objects.equals(this.campaign, eventCustomerRedemptionSucceeded.campaign) &&
  ...
  public String toString() {
    ...
    sb.append("class EventCustomerRedemptionSucceeded {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EventCustomerRedemptionSucceeded
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventCustomerRedemptionSucceeded.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventCustomerRedemptionSucceeded is not found in the empty JSON string", EventCustomerRedemptionSucceeded.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventCustomerRedemptionSucceeded.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventCustomerRedemptionSucceeded` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventCustomerRedemptionSucceeded.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventCustomerRedemptionSucceeded' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventCustomerRedemptionSucceeded> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventCustomerRedemptionSucceeded.class));

       return (TypeAdapter<T>) new TypeAdapter<EventCustomerRedemptionSucceeded>() {
           @Override
           public void write(JsonWriter out, EventCustomerRedemptionSucceeded value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventCustomerRedemptionSucceeded read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EventCustomerRedemptionSucceeded given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventCustomerRedemptionSucceeded
  * @throws IOException if the JSON string is invalid with respect to EventCustomerRedemptionSucceeded
  */
  public static EventCustomerRedemptionSucceeded fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventCustomerRedemptionSucceeded.class);
  }

 /**
  * Convert an instance of EventCustomerRedemptionSucceeded to an JSON string
  *
  * @return JSON string
  */
