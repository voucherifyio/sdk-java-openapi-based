...
import org.openapitools.client.model.RedemptionRewardResultParameters;
import org.openapitools.client.model.RedemptionRewardResultProduct;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedemptionRewardResult.openapiFields.contains(entry.getKey())) {
