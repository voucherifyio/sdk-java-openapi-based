...
import org.openapitools.client.model.VoucherTransactionsExportFilterConditions;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VoucherTransactionsFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VoucherTransactionsFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
