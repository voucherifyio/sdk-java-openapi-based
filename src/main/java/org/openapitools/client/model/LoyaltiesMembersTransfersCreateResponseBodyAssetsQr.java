...
public class LoyaltiesMembersTransfersCreateResponseBodyAssetsQr {
  ...
  * @throws IOException if the JSON Element is invalid with respect to LoyaltiesMembersTransfersCreateResponseBodyAssetsQr
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoyaltiesMembersTransfersCreateResponseBodyAssetsQr.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoyaltiesMembersTransfersCreateResponseBodyAssetsQr is not found in the empty JSON string", LoyaltiesMembersTransfersCreateResponseBodyAssetsQr.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoyaltiesMembersTransfersCreateResponseBodyAssetsQr.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoyaltiesMembersTransfersCreateResponseBodyAssetsQr` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
