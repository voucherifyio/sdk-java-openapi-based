...
public class PromotionTier {
  ...
  **/
  ...
  public PromotionTier validityTimeframe(PromotionTierValidityTimeframe validityTimeframe) {
  ...
  **/
  ...
  public PromotionTier validityDayOfWeek(List<Integer> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public PromotionTier addValidityDayOfWeekItem(Integer validityDayOfWeekItem) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromotionTier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PromotionTier is not found in the empty JSON string", PromotionTier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PromotionTier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PromotionTier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
