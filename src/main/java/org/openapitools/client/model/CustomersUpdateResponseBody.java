...
public class CustomersUpdateResponseBody {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CustomersUpdateResponseBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomersUpdateResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomersUpdateResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
