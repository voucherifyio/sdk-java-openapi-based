...
import org.openapitools.client.model.EarningRuleBaseCustomEvent;
import org.openapitools.client.model.EarningRuleBaseLoyalty;
import org.openapitools.client.model.EarningRuleBaseSegment;
...
public class LoyaltiesEarningRulesEnableResponseBody {
  ...
  **/
  ...
  public LoyaltiesEarningRulesEnableResponseBody validityTimeframe(EarningRuleBaseValidityTimeframe validityTimeframe) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoyaltiesEarningRulesEnableResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoyaltiesEarningRulesEnableResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
