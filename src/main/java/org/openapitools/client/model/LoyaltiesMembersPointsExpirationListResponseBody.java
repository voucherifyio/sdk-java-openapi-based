...
import org.openapitools.client.model.LoyaltiesMembersPointsExpirationListResponseBodyDataItem;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoyaltiesMembersPointsExpirationListResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoyaltiesMembersPointsExpirationListResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
