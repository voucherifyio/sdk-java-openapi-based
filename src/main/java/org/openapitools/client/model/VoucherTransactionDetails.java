...
import org.openapitools.client.model.VoucherTransactionDetailsBalance;
import org.openapitools.client.model.VoucherTransactionDetailsCustomEvent;
import org.openapitools.client.model.VoucherTransactionDetailsEarningRule;
import org.openapitools.client.model.VoucherTransactionDetailsEvent;
import org.openapitools.client.model.VoucherTransactionDetailsEventSchema;
import org.openapitools.client.model.VoucherTransactionDetailsLoyaltyTier;
import org.openapitools.client.model.VoucherTransactionDetailsOrder;
import org.openapitools.client.model.VoucherTransactionDetailsRedemption;
import org.openapitools.client.model.VoucherTransactionDetailsReward;
import org.openapitools.client.model.VoucherTransactionDetailsRollback;
import org.openapitools.client.model.VoucherTransactionDetailsSegment;
...
public class VoucherTransactionDetails {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VoucherTransactionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VoucherTransactionDetails is not found in the empty JSON string", VoucherTransactionDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VoucherTransactionDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VoucherTransactionDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
