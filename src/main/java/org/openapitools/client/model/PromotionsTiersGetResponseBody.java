...
public class PromotionsTiersGetResponseBody {
  ...
  **/
  ...
  public PromotionsTiersGetResponseBody validityTimeframe(PromotionTierValidityTimeframe validityTimeframe) {
  ...
  **/
  ...
  public PromotionsTiersGetResponseBody validityDayOfWeek(List<Integer> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public PromotionsTiersGetResponseBody addValidityDayOfWeekItem(Integer validityDayOfWeekItem) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PromotionsTiersGetResponseBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromotionsTiersGetResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PromotionsTiersGetResponseBody is not found in the empty JSON string", PromotionsTiersGetResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PromotionsTiersGetResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PromotionsTiersGetResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
