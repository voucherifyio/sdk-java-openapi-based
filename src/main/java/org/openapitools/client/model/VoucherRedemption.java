...
public class VoucherRedemption {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VoucherRedemption
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VoucherRedemption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VoucherRedemption is not found in the empty JSON string", VoucherRedemption.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VoucherRedemption.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VoucherRedemption` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
