...
public class ExportOrder {
  ...
  public ExportOrder id(String id) {
  ...
  **/
  ...
  public ExportOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public ExportOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ExportOrder status(StatusEnum status) {
  ...
  **/
  ...
  public ExportOrder channel(String channel) {
  ...
  **/
  ...
  public ExportOrder result(ExportBaseResult result) {
  ...
  **/
  ...
  public ExportOrder userId(String userId) {
  ...
  **/
  ...
  public ExportOrder exportedObject(ExportedObjectEnum exportedObject) {
  ...
  **/
  ...
  public ExportOrder parameters(OrdersExportCreateRequestBodyParameters parameters) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ExportOrder exportOrder = (ExportOrder) o;
    return Objects.equals(this.id, exportOrder.id) &&
        Objects.equals(this._object, exportOrder._object) &&
        Objects.equals(this.createdAt, exportOrder.createdAt) &&
        Objects.equals(this.status, exportOrder.status) &&
        Objects.equals(this.channel, exportOrder.channel) &&
        Objects.equals(this.result, exportOrder.result) &&
        Objects.equals(this.userId, exportOrder.userId) &&
        Objects.equals(this.exportedObject, exportOrder.exportedObject) &&
        Objects.equals(this.parameters, exportOrder.parameters);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ExportOrder
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportOrder is not found in the empty JSON string", ExportOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportOrder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportOrder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExportOrder.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportOrder>() {
           @Override
           public void write(JsonWriter out, ExportOrder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ExportOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExportOrder
  * @throws IOException if the JSON string is invalid with respect to ExportOrder
  */
  public static ExportOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportOrder.class);
  }

 /**
  * Convert an instance of ExportOrder to an JSON string
  *
  * @return JSON string
  */
