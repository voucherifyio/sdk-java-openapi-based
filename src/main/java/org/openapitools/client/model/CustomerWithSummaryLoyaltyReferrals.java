...
public class CustomerWithSummaryLoyaltyReferrals {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, email, phone, birthday, birthdate, address, metadata, id, sourceId, summary, loyalty, referrals, systemMetadata, createdAt, updatedAt, assets, _object);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerWithSummaryLoyaltyReferrals.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerWithSummaryLoyaltyReferrals` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
