...
import org.openapitools.client.model.RedemptionRewardResultParametersCampaign;
import org.openapitools.client.model.RedemptionRewardResultParametersCoin;
import org.openapitools.client.model.RedemptionRewardResultParametersProduct;
...
public class RedemptionRewardResultParameters {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedemptionRewardResultParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedemptionRewardResultParameters is not found in the empty JSON string", RedemptionRewardResultParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedemptionRewardResultParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedemptionRewardResultParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
