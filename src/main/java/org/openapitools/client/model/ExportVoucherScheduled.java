...
public class ExportVoucherScheduled {
  ...
  public ExportVoucherScheduled() {
  }

  public ExportVoucherScheduled id(String id) {
  ...
  **/
  ...
  public ExportVoucherScheduled _object(ObjectEnum _object) {
  ...
  **/
  ...
  public ExportVoucherScheduled createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ExportVoucherScheduled status(StatusEnum status) {
  ...
  **/
  ...
  public ExportVoucherScheduled channel(String channel) {
  ...
  **/
  ...
  public ExportVoucherScheduled result(Object result) {
  ...
  **/
  ...
  public ExportVoucherScheduled userId(String userId) {
  ...
  **/
  ...
  public ExportVoucherScheduled exportedObject(ExportedObjectEnum exportedObject) {
  ...
  **/
  ...
  public ExportVoucherScheduled parameters(ExportVoucherBaseParameters parameters) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ExportVoucherScheduled exportVoucherScheduled = (ExportVoucherScheduled) o;
    return Objects.equals(this.id, exportVoucherScheduled.id) &&
        Objects.equals(this._object, exportVoucherScheduled._object) &&
        Objects.equals(this.createdAt, exportVoucherScheduled.createdAt) &&
        Objects.equals(this.status, exportVoucherScheduled.status) &&
        Objects.equals(this.channel, exportVoucherScheduled.channel) &&
        Objects.equals(this.result, exportVoucherScheduled.result) &&
        Objects.equals(this.userId, exportVoucherScheduled.userId) &&
        Objects.equals(this.exportedObject, exportVoucherScheduled.exportedObject) &&
        Objects.equals(this.parameters, exportVoucherScheduled.parameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportVoucherScheduled {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ExportVoucherScheduled
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportVoucherScheduled.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportVoucherScheduled is not found in the empty JSON string", ExportVoucherScheduled.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportVoucherScheduled.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportVoucherScheduled` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExportVoucherScheduled.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportVoucherScheduled.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportVoucherScheduled' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportVoucherScheduled> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportVoucherScheduled.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportVoucherScheduled>() {
           @Override
           public void write(JsonWriter out, ExportVoucherScheduled value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportVoucherScheduled read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ExportVoucherScheduled given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExportVoucherScheduled
  * @throws IOException if the JSON string is invalid with respect to ExportVoucherScheduled
  */
  public static ExportVoucherScheduled fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportVoucherScheduled.class);
  }

 /**
  * Convert an instance of ExportVoucherScheduled to an JSON string
  *
  * @return JSON string
  */
