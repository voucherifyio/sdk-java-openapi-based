...
import org.openapitools.client.model.OrderCalculatedCustomer;
import org.openapitools.client.model.OrderCalculatedReferrer;
import org.openapitools.client.model.OrderItemCalculated;
import org.openapitools.client.model.OrderRedemptions;
...
public class OrdersCreateResponseBody {
  ...
  **/
  ...
  public OrdersCreateResponseBody customer(OrderCalculatedCustomer customer) {
  ...
  **/
  ...
  public OrdersCreateResponseBody referrer(OrderCalculatedReferrer referrer) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrdersCreateResponseBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrdersCreateResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersCreateResponseBody is not found in the empty JSON string", OrdersCreateResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrdersCreateResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrdersCreateResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrdersCreateResponseBody.openapiRequiredFields) {
