...
import org.openapitools.client.model.LoyaltyCardTransaction;
...
public class LoyaltiesMembersTransactionsListResponseBody {
  ...
  * @throws IOException if the JSON Element is invalid with respect to LoyaltiesMembersTransactionsListResponseBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoyaltiesMembersTransactionsListResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoyaltiesMembersTransactionsListResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoyaltiesMembersTransactionsListResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
