...
public class ListPublicationsItemValidSingleVoucher {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ListPublicationsItemValidSingleVoucher
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPublicationsItemValidSingleVoucher.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPublicationsItemValidSingleVoucher is not found in the empty JSON string", ListPublicationsItemValidSingleVoucher.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPublicationsItemValidSingleVoucher.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPublicationsItemValidSingleVoucher` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPublicationsItemValidSingleVoucher.openapiRequiredFields) {
