...
public class FilterConditionsDateTimeConditions {
  ...
  * @throws IOException if the JSON Element is invalid with respect to FilterConditionsDateTimeConditions
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FilterConditionsDateTimeConditions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilterConditionsDateTimeConditions is not found in the empty JSON string", FilterConditionsDateTimeConditions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FilterConditionsDateTimeConditions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FilterConditionsDateTimeConditions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
