...
public class RedemptionRelatedRedemptionsRollbacksItem {
  ...
  * @throws IOException if the JSON Element is invalid with respect to RedemptionRelatedRedemptionsRollbacksItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedemptionRelatedRedemptionsRollbacksItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedemptionRelatedRedemptionsRollbacksItem is not found in the empty JSON string", RedemptionRelatedRedemptionsRollbacksItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedemptionRelatedRedemptionsRollbacksItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedemptionRelatedRedemptionsRollbacksItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
