...
import voucherify.client.model.CustomerRedeemableRedeemable;
...
public class CustomerRedeemable {
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("redeemable");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CustomerRedeemable
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerRedeemable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomerRedeemable is not found in the empty JSON string", CustomerRedeemable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerRedeemable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerRedeemable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomerRedeemable.openapiRequiredFields) {
      ...
      // validate the required field `redeemable`
      CustomerRedeemableRedeemable.validateJsonElement(jsonObj.get("redeemable"));
  }
