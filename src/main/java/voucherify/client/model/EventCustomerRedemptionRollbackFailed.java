...
public class EventCustomerRedemptionRollbackFailed {
  ...
  public EventCustomerRedemptionRollbackFailed() {
  }

  public EventCustomerRedemptionRollbackFailed customer(SimpleCustomer customer) {
  ...
  **/
  ...
  public EventCustomerRedemptionRollbackFailed order(SimpleOrder order) {
  ...
  **/
  ...
  public EventCustomerRedemptionRollbackFailed campaign(SimpleCampaign campaign) {
  ...
  **/
  ...
  public EventCustomerRedemptionRollbackFailed voucher(SimpleVoucher voucher) {
  ...
  **/
  ...
  public EventCustomerRedemptionRollbackFailed holder(SimpleCustomer holder) {
  ...
  **/
  ...
  public EventCustomerRedemptionRollbackFailed promotionTier(SimplePromotionTier promotionTier) {
  ...
  **/
  ...
  public EventCustomerRedemptionRollbackFailed promotionStack(SimplePromotionStack promotionStack) {
  ...
  **/
  ...
  public EventCustomerRedemptionRollbackFailed redemption(SimpleRedemption redemption) {
  ...
  **/
  ...
  public EventCustomerRedemptionRollbackFailed redemptionRollback(SimpleRedemption redemptionRollback) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EventCustomerRedemptionRollbackFailed eventCustomerRedemptionRollbackFailed = (EventCustomerRedemptionRollbackFailed) o;
    return Objects.equals(this.customer, eventCustomerRedemptionRollbackFailed.customer) &&
        Objects.equals(this.order, eventCustomerRedemptionRollbackFailed.order) &&
        Objects.equals(this.campaign, eventCustomerRedemptionRollbackFailed.campaign) &&
        Objects.equals(this.voucher, eventCustomerRedemptionRollbackFailed.voucher) &&
        Objects.equals(this.holder, eventCustomerRedemptionRollbackFailed.holder) &&
        Objects.equals(this.promotionTier, eventCustomerRedemptionRollbackFailed.promotionTier) &&
        Objects.equals(this.promotionStack, eventCustomerRedemptionRollbackFailed.promotionStack) &&
        Objects.equals(this.redemption, eventCustomerRedemptionRollbackFailed.redemption) &&
        Objects.equals(this.redemptionRollback, eventCustomerRedemptionRollbackFailed.redemptionRollback);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventCustomerRedemptionRollbackFailed {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EventCustomerRedemptionRollbackFailed
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventCustomerRedemptionRollbackFailed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventCustomerRedemptionRollbackFailed is not found in the empty JSON string", EventCustomerRedemptionRollbackFailed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventCustomerRedemptionRollbackFailed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventCustomerRedemptionRollbackFailed` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("redemption_rollback") != null && !jsonObj.get("redemption_rollback").isJsonNull()) {
        SimpleRedemption.validateJsonElement(jsonObj.get("redemption_rollback"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventCustomerRedemptionRollbackFailed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventCustomerRedemptionRollbackFailed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventCustomerRedemptionRollbackFailed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventCustomerRedemptionRollbackFailed.class));

       return (TypeAdapter<T>) new TypeAdapter<EventCustomerRedemptionRollbackFailed>() {
           @Override
           public void write(JsonWriter out, EventCustomerRedemptionRollbackFailed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventCustomerRedemptionRollbackFailed read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EventCustomerRedemptionRollbackFailed given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventCustomerRedemptionRollbackFailed
  * @throws IOException if the JSON string is invalid with respect to EventCustomerRedemptionRollbackFailed
  */
  public static EventCustomerRedemptionRollbackFailed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventCustomerRedemptionRollbackFailed.class);
  }

 /**
  * Convert an instance of EventCustomerRedemptionRollbackFailed to an JSON string
  *
  * @return JSON string
  */
