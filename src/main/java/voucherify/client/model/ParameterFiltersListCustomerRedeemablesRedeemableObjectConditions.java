...
public class ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions is not found in the empty JSON string", ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
