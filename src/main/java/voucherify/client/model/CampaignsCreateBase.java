...
public class CampaignsCreateBase {
  ...
  **/
  ...
  public CampaignsCreateBase validityTimeframe(CampaignBaseValidityTimeframe validityTimeframe) {
  ...
  **/
  ...
  public CampaignsCreateBase validityDayOfWeek(List<Integer> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public CampaignsCreateBase addValidityDayOfWeekItem(Integer validityDayOfWeekItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, type, joinOnce, autoJoin, useVoucherMetadataSchema, vouchersCount, startDate, expirationDate, validityTimeframe, validityDayOfWeek, activityDurationAfterPublishing, validationRules, categoryId, category, metadata);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CampaignsCreateBase
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignsCreateBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsCreateBase is not found in the empty JSON string", CampaignsCreateBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignsCreateBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignsCreateBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
