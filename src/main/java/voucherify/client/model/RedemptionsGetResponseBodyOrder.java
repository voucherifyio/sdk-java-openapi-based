...
public class RedemptionsGetResponseBodyOrder {
  ...
  * @throws IOException if the JSON Element is invalid with respect to RedemptionsGetResponseBodyOrder
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedemptionsGetResponseBodyOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedemptionsGetResponseBodyOrder is not found in the empty JSON string", RedemptionsGetResponseBodyOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedemptionsGetResponseBodyOrder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedemptionsGetResponseBodyOrder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
