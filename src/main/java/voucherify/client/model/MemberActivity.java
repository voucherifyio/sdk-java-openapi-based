...
import voucherify.client.model.MemberActivityData;
...
public class MemberActivity {
  ...
  **/
  ...
  public MemberActivity data(MemberActivityData data) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to MemberActivity
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MemberActivity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MemberActivity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MemberActivity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
