...
public class FilterConditionsDateTime {
  ...
  * @throws IOException if the JSON Element is invalid with respect to FilterConditionsDateTime
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FilterConditionsDateTime.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilterConditionsDateTime is not found in the empty JSON string", FilterConditionsDateTime.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FilterConditionsDateTime.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FilterConditionsDateTime` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
