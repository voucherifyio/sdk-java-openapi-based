...
public class CustomersUpdateInBulkRequestBody {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, email, phone, birthday, birthdate, address, metadata, sourceId);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CustomersUpdateInBulkRequestBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomersUpdateInBulkRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomersUpdateInBulkRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
