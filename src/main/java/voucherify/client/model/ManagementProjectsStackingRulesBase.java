...
public class ManagementProjectsStackingRulesBase {
  ...
  public ManagementProjectsStackingRulesBase() {
  }

  public ManagementProjectsStackingRulesBase exclusiveCategories(List<String> exclusiveCategories) {
    
    this.exclusiveCategories = exclusiveCategories;
    return this;
  }

  public ManagementProjectsStackingRulesBase addExclusiveCategoriesItem(String exclusiveCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase jointCategories(List<String> jointCategories) {
    
    this.jointCategories = jointCategories;
    return this;
  }

  public ManagementProjectsStackingRulesBase addJointCategoriesItem(String jointCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase redeemablesLimit(Integer redeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase applicableRedeemablesLimit(Integer applicableRedeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase applicableRedeemablesPerCategoryLimit(Integer applicableRedeemablesPerCategoryLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase applicableExclusiveRedeemablesLimit(Integer applicableExclusiveRedeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase applicableExclusiveRedeemablesPerCategoryLimit(Integer applicableExclusiveRedeemablesPerCategoryLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase discountCalculationMode(DiscountCalculationModeEnum discountCalculationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase initialAmountModeCategories(List<String> initialAmountModeCategories) {
    
    this.initialAmountModeCategories = initialAmountModeCategories;
    return this;
  }

  public ManagementProjectsStackingRulesBase addInitialAmountModeCategoriesItem(String initialAmountModeCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase discountedAmountModeCategories(List<String> discountedAmountModeCategories) {
    
    this.discountedAmountModeCategories = discountedAmountModeCategories;
    return this;
  }

  public ManagementProjectsStackingRulesBase addDiscountedAmountModeCategoriesItem(String discountedAmountModeCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase redeemablesApplicationMode(RedeemablesApplicationModeEnum redeemablesApplicationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBase redeemablesSortingRule(RedeemablesSortingRuleEnum redeemablesSortingRule) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsStackingRulesBase managementProjectsStackingRulesBase = (ManagementProjectsStackingRulesBase) o;
    return Objects.equals(this.exclusiveCategories, managementProjectsStackingRulesBase.exclusiveCategories) &&
        Objects.equals(this.jointCategories, managementProjectsStackingRulesBase.jointCategories) &&
        Objects.equals(this.redeemablesLimit, managementProjectsStackingRulesBase.redeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesLimit, managementProjectsStackingRulesBase.applicableRedeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesPerCategoryLimit, managementProjectsStackingRulesBase.applicableRedeemablesPerCategoryLimit) &&
        Objects.equals(this.applicableExclusiveRedeemablesLimit, managementProjectsStackingRulesBase.applicableExclusiveRedeemablesLimit) &&
        Objects.equals(this.applicableExclusiveRedeemablesPerCategoryLimit, managementProjectsStackingRulesBase.applicableExclusiveRedeemablesPerCategoryLimit) &&
        Objects.equals(this.discountCalculationMode, managementProjectsStackingRulesBase.discountCalculationMode) &&
        Objects.equals(this.initialAmountModeCategories, managementProjectsStackingRulesBase.initialAmountModeCategories) &&
        Objects.equals(this.discountedAmountModeCategories, managementProjectsStackingRulesBase.discountedAmountModeCategories) &&
        Objects.equals(this.redeemablesApplicationMode, managementProjectsStackingRulesBase.redeemablesApplicationMode) &&
        Objects.equals(this.redeemablesSortingRule, managementProjectsStackingRulesBase.redeemablesSortingRule);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsStackingRulesBase {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ManagementProjectsStackingRulesBase
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagementProjectsStackingRulesBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagementProjectsStackingRulesBase is not found in the empty JSON string", ManagementProjectsStackingRulesBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagementProjectsStackingRulesBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagementProjectsStackingRulesBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("discount_calculation_mode") != null && !jsonObj.get("discount_calculation_mode").isJsonNull()) && !jsonObj.get("discount_calculation_mode").isJsonPrimitive()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("initial_amount_mode_categories") != null && !jsonObj.get("initial_amount_mode_categories").isJsonNull() && !jsonObj.get("initial_amount_mode_categories").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("discounted_amount_mode_categories") != null && !jsonObj.get("discounted_amount_mode_categories").isJsonNull() && !jsonObj.get("discounted_amount_mode_categories").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsStackingRulesBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsStackingRulesBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsStackingRulesBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsStackingRulesBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsStackingRulesBase>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsStackingRulesBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagementProjectsStackingRulesBase read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsStackingRulesBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsStackingRulesBase
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsStackingRulesBase
  */
  public static ManagementProjectsStackingRulesBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsStackingRulesBase.class);
  }

 /**
  * Convert an instance of ManagementProjectsStackingRulesBase to an JSON string
  *
  * @return JSON string
  */
