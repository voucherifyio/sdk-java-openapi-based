...
public class CampaignsUpdateResponseBody {
  ...
  **/
  ...
  public CampaignsUpdateResponseBody validityTimeframe(CampaignBaseValidityTimeframe validityTimeframe) {
  ...
  **/
  ...
  public CampaignsUpdateResponseBody validityDayOfWeek(List<Integer> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public CampaignsUpdateResponseBody addValidityDayOfWeekItem(Integer validityDayOfWeekItem) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignsUpdateResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsUpdateResponseBody is not found in the empty JSON string", CampaignsUpdateResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignsUpdateResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignsUpdateResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CampaignsUpdateResponseBody.openapiRequiredFields) {
