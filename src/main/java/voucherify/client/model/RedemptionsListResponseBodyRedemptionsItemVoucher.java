...
import voucherify.client.model.RedemptionsListResponseBodyRedemptionsItemVoucherValidityTimeframe;
...
public class RedemptionsListResponseBodyRedemptionsItemVoucher {
  ...
  private RedemptionsListResponseBodyRedemptionsItemVoucherValidityTimeframe validityTimeframe;
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemVoucher validityTimeframe(RedemptionsListResponseBodyRedemptionsItemVoucherValidityTimeframe validityTimeframe) {
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionsListResponseBodyRedemptionsItemVoucherValidityTimeframe getValidityTimeframe() {
    return validityTimeframe;
  }


  public void setValidityTimeframe(RedemptionsListResponseBodyRedemptionsItemVoucherValidityTimeframe validityTimeframe) {
    this.validityTimeframe = validityTimeframe;
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to RedemptionsListResponseBodyRedemptionsItemVoucher
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedemptionsListResponseBodyRedemptionsItemVoucher.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedemptionsListResponseBodyRedemptionsItemVoucher is not found in the empty JSON string", RedemptionsListResponseBodyRedemptionsItemVoucher.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedemptionsListResponseBodyRedemptionsItemVoucher.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedemptionsListResponseBodyRedemptionsItemVoucher` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("gift") != null && !jsonObj.get("gift").isJsonNull()) {
        RedemptionsListResponseBodyRedemptionsItemVoucherGift.validateJsonElement(jsonObj.get("gift"));
      }
      // validate the optional field `loyalty_card`
      if (jsonObj.get("loyalty_card") != null && !jsonObj.get("loyalty_card").isJsonNull()) {
        RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.validateJsonElement(jsonObj.get("loyalty_card"));
      }
      ...
      if (jsonObj.get("validity_timeframe") != null && !jsonObj.get("validity_timeframe").isJsonNull()) {
        RedemptionsListResponseBodyRedemptionsItemVoucherValidityTimeframe.validateJsonElement(jsonObj.get("validity_timeframe"));
      }
      ...
      if (jsonObj.get("publish") != null && !jsonObj.get("publish").isJsonNull()) {
        RedemptionsListResponseBodyRedemptionsItemVoucherPublish.validateJsonElement(jsonObj.get("publish"));
      }
      // validate the optional field `redemption`
      if (jsonObj.get("redemption") != null && !jsonObj.get("redemption").isJsonNull()) {
        RedemptionsListResponseBodyRedemptionsItemVoucherRedemption.validateJsonElement(jsonObj.get("redemption"));
      }
