...
public class ExportsCreateRequestBodyParameters {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ExportsCreateRequestBodyParameters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportsCreateRequestBodyParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportsCreateRequestBodyParameters is not found in the empty JSON string", ExportsCreateRequestBodyParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportsCreateRequestBodyParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportsCreateRequestBodyParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        ExportsCreateRequestBodyParametersFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
