...
import voucherify.client.model.DiscountCouponsCampaignVoucher;
...
public class CampaignsCreateDiscountCouponsCampaign {
  ...
  private DiscountCouponsCampaignVoucher voucher;

  public CampaignsCreateDiscountCouponsCampaign() {
  }

  public CampaignsCreateDiscountCouponsCampaign name(String name) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign description(String description) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign type(TypeEnum type) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign joinOnce(Boolean joinOnce) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign autoJoin(Boolean autoJoin) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign useVoucherMetadataSchema(Boolean useVoucherMetadataSchema) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign vouchersCount(Integer vouchersCount) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign expirationDate(OffsetDateTime expirationDate) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign validityTimeframe(CampaignBaseValidityTimeframe validityTimeframe) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign validityDayOfWeek(List<ValidityDayOfWeekEnum> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public CampaignsCreateDiscountCouponsCampaign addValidityDayOfWeekItem(ValidityDayOfWeekEnum validityDayOfWeekItem) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign validityHours(ValidityHours validityHours) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign activityDurationAfterPublishing(String activityDurationAfterPublishing) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign validationRules(List<String> validationRules) {
    
    this.validationRules = validationRules;
    return this;
  }

  public CampaignsCreateDiscountCouponsCampaign addValidationRulesItem(String validationRulesItem) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign categoryId(String categoryId) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign category(String category) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign metadata(Object metadata) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign campaignType(CampaignTypeEnum campaignType) {
  ...
  **/
  ...
  public CampaignsCreateDiscountCouponsCampaign voucher(DiscountCouponsCampaignVoucher voucher) {
  ...
  **/
  @javax.annotation.Nullable
  public DiscountCouponsCampaignVoucher getVoucher() {
    return voucher;
  }


  public void setVoucher(DiscountCouponsCampaignVoucher voucher) {
    this.voucher = voucher;
  }
  ...
  public boolean equals(Object o) {
    ...
    CampaignsCreateDiscountCouponsCampaign campaignsCreateDiscountCouponsCampaign = (CampaignsCreateDiscountCouponsCampaign) o;
    return Objects.equals(this.name, campaignsCreateDiscountCouponsCampaign.name) &&
        Objects.equals(this.description, campaignsCreateDiscountCouponsCampaign.description) &&
        Objects.equals(this.type, campaignsCreateDiscountCouponsCampaign.type) &&
        Objects.equals(this.joinOnce, campaignsCreateDiscountCouponsCampaign.joinOnce) &&
        Objects.equals(this.autoJoin, campaignsCreateDiscountCouponsCampaign.autoJoin) &&
        Objects.equals(this.useVoucherMetadataSchema, campaignsCreateDiscountCouponsCampaign.useVoucherMetadataSchema) &&
        Objects.equals(this.vouchersCount, campaignsCreateDiscountCouponsCampaign.vouchersCount) &&
        Objects.equals(this.startDate, campaignsCreateDiscountCouponsCampaign.startDate) &&
        Objects.equals(this.expirationDate, campaignsCreateDiscountCouponsCampaign.expirationDate) &&
        Objects.equals(this.validityTimeframe, campaignsCreateDiscountCouponsCampaign.validityTimeframe) &&
        Objects.equals(this.validityDayOfWeek, campaignsCreateDiscountCouponsCampaign.validityDayOfWeek) &&
        Objects.equals(this.validityHours, campaignsCreateDiscountCouponsCampaign.validityHours) &&
        Objects.equals(this.activityDurationAfterPublishing, campaignsCreateDiscountCouponsCampaign.activityDurationAfterPublishing) &&
        Objects.equals(this.validationRules, campaignsCreateDiscountCouponsCampaign.validationRules) &&
        Objects.equals(this.categoryId, campaignsCreateDiscountCouponsCampaign.categoryId) &&
        Objects.equals(this.category, campaignsCreateDiscountCouponsCampaign.category) &&
        Objects.equals(this.metadata, campaignsCreateDiscountCouponsCampaign.metadata) &&
        Objects.equals(this.campaignType, campaignsCreateDiscountCouponsCampaign.campaignType) &&
        Objects.equals(this.voucher, campaignsCreateDiscountCouponsCampaign.voucher);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsCreateDiscountCouponsCampaign {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CampaignsCreateDiscountCouponsCampaign
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignsCreateDiscountCouponsCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsCreateDiscountCouponsCampaign is not found in the empty JSON string", CampaignsCreateDiscountCouponsCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignsCreateDiscountCouponsCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignsCreateDiscountCouponsCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("voucher") != null && !jsonObj.get("voucher").isJsonNull()) {
        DiscountCouponsCampaignVoucher.validateJsonElement(jsonObj.get("voucher"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsCreateDiscountCouponsCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsCreateDiscountCouponsCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsCreateDiscountCouponsCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsCreateDiscountCouponsCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsCreateDiscountCouponsCampaign>() {
           @Override
           public void write(JsonWriter out, CampaignsCreateDiscountCouponsCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignsCreateDiscountCouponsCampaign read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignsCreateDiscountCouponsCampaign given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsCreateDiscountCouponsCampaign
  * @throws IOException if the JSON string is invalid with respect to CampaignsCreateDiscountCouponsCampaign
  */
  public static CampaignsCreateDiscountCouponsCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsCreateDiscountCouponsCampaign.class);
  }

 /**
  * Convert an instance of CampaignsCreateDiscountCouponsCampaign to an JSON string
  *
  * @return JSON string
  */
