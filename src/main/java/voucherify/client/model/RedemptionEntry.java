...
public class RedemptionEntry {
  ...
  * @throws IOException if the JSON Element is invalid with respect to RedemptionEntry
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("related_redemptions") != null && !jsonObj.get("related_redemptions").isJsonNull()) {
        RedemptionEntryRelatedRedemptions.validateJsonElement(jsonObj.get("related_redemptions"));
      }
      ...
      if (jsonObj.get("order") != null && !jsonObj.get("order").isJsonNull()) {
        RedemptionEntryOrder.validateJsonElement(jsonObj.get("order"));
      }
      // validate the optional field `channel`
      if (jsonObj.get("channel") != null && !jsonObj.get("channel").isJsonNull()) {
        RedemptionEntryChannel.validateJsonElement(jsonObj.get("channel"));
      }
      // validate the optional field `customer`
      if (jsonObj.get("customer") != null && !jsonObj.get("customer").isJsonNull()) {
        RedemptionEntryCustomer.validateJsonElement(jsonObj.get("customer"));
      }
      ...
      if (jsonObj.get("voucher") != null && !jsonObj.get("voucher").isJsonNull()) {
        RedemptionEntryVoucher.validateJsonElement(jsonObj.get("voucher"));
      }
      // validate the optional field `promotion_tier`
      if (jsonObj.get("promotion_tier") != null && !jsonObj.get("promotion_tier").isJsonNull()) {
        RedemptionEntryPromotionTier.validateJsonElement(jsonObj.get("promotion_tier"));
      }
      ...
      if (jsonObj.get("gift") != null && !jsonObj.get("gift").isJsonNull()) {
        RedemptionEntryGift.validateJsonElement(jsonObj.get("gift"));
      }
      // validate the optional field `loyalty_card`
      if (jsonObj.get("loyalty_card") != null && !jsonObj.get("loyalty_card").isJsonNull()) {
        RedemptionEntryLoyaltyCard.validateJsonElement(jsonObj.get("loyalty_card"));
      }
