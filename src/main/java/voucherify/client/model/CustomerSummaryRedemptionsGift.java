...
public class CustomerSummaryRedemptionsGift {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CustomerSummaryRedemptionsGift
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerSummaryRedemptionsGift.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerSummaryRedemptionsGift` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
