...
public class ParameterFiltersListRedemptionsCustomerId {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ParameterFiltersListRedemptionsCustomerId
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterFiltersListRedemptionsCustomerId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ParameterFiltersListRedemptionsCustomerId is not found in the empty JSON string", ParameterFiltersListRedemptionsCustomerId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParameterFiltersListRedemptionsCustomerId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParameterFiltersListRedemptionsCustomerId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
