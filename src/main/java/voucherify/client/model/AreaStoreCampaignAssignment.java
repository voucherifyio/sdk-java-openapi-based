...
public class AreaStoreCampaignAssignment {
  ...
  * @throws IOException if the JSON Element is invalid with respect to AreaStoreCampaignAssignment
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("area_id") != null && !jsonObj.get("area_id").isJsonNull()) && !jsonObj.get("area_id").isJsonPrimitive()) {
        return;
      }
      if ((jsonObj.get("area_store_id") != null && !jsonObj.get("area_store_id").isJsonNull()) && !jsonObj.get("area_store_id").isJsonPrimitive()) {
        return;
      }
