...
public class ManagementProjectsStackingRulesBaseResponseBody {
  ...
  public ManagementProjectsStackingRulesBaseResponseBody() {
  }

  public ManagementProjectsStackingRulesBaseResponseBody exclusiveCategories(List<String> exclusiveCategories) {
    
    this.exclusiveCategories = exclusiveCategories;
    return this;
  }

  public ManagementProjectsStackingRulesBaseResponseBody addExclusiveCategoriesItem(String exclusiveCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody jointCategories(List<String> jointCategories) {
    
    this.jointCategories = jointCategories;
    return this;
  }

  public ManagementProjectsStackingRulesBaseResponseBody addJointCategoriesItem(String jointCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody redeemablesLimit(Integer redeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody applicableRedeemablesLimit(Integer applicableRedeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody applicableRedeemablesPerCategoryLimit(Integer applicableRedeemablesPerCategoryLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody applicableExclusiveRedeemablesLimit(Integer applicableExclusiveRedeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody applicableExclusiveRedeemablesPerCategoryLimit(Integer applicableExclusiveRedeemablesPerCategoryLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody discountCalculationMode(DiscountCalculationModeEnum discountCalculationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody initialAmountModeCategories(List<String> initialAmountModeCategories) {
    
    this.initialAmountModeCategories = initialAmountModeCategories;
    return this;
  }

  public ManagementProjectsStackingRulesBaseResponseBody addInitialAmountModeCategoriesItem(String initialAmountModeCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody discountedAmountModeCategories(List<String> discountedAmountModeCategories) {
    
    this.discountedAmountModeCategories = discountedAmountModeCategories;
    return this;
  }

  public ManagementProjectsStackingRulesBaseResponseBody addDiscountedAmountModeCategoriesItem(String discountedAmountModeCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody redeemablesApplicationMode(RedeemablesApplicationModeEnum redeemablesApplicationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody redeemablesSortingRule(RedeemablesSortingRuleEnum redeemablesSortingRule) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody id(String id) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesBaseResponseBody createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsStackingRulesBaseResponseBody managementProjectsStackingRulesBaseResponseBody = (ManagementProjectsStackingRulesBaseResponseBody) o;
    return Objects.equals(this.exclusiveCategories, managementProjectsStackingRulesBaseResponseBody.exclusiveCategories) &&
        Objects.equals(this.jointCategories, managementProjectsStackingRulesBaseResponseBody.jointCategories) &&
        Objects.equals(this.redeemablesLimit, managementProjectsStackingRulesBaseResponseBody.redeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesLimit, managementProjectsStackingRulesBaseResponseBody.applicableRedeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesPerCategoryLimit, managementProjectsStackingRulesBaseResponseBody.applicableRedeemablesPerCategoryLimit) &&
        Objects.equals(this.applicableExclusiveRedeemablesLimit, managementProjectsStackingRulesBaseResponseBody.applicableExclusiveRedeemablesLimit) &&
        Objects.equals(this.applicableExclusiveRedeemablesPerCategoryLimit, managementProjectsStackingRulesBaseResponseBody.applicableExclusiveRedeemablesPerCategoryLimit) &&
        Objects.equals(this.discountCalculationMode, managementProjectsStackingRulesBaseResponseBody.discountCalculationMode) &&
        Objects.equals(this.initialAmountModeCategories, managementProjectsStackingRulesBaseResponseBody.initialAmountModeCategories) &&
        Objects.equals(this.discountedAmountModeCategories, managementProjectsStackingRulesBaseResponseBody.discountedAmountModeCategories) &&
        Objects.equals(this.redeemablesApplicationMode, managementProjectsStackingRulesBaseResponseBody.redeemablesApplicationMode) &&
        Objects.equals(this.redeemablesSortingRule, managementProjectsStackingRulesBaseResponseBody.redeemablesSortingRule) &&
        Objects.equals(this.id, managementProjectsStackingRulesBaseResponseBody.id) &&
        Objects.equals(this.createdAt, managementProjectsStackingRulesBaseResponseBody.createdAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsStackingRulesBaseResponseBody {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ManagementProjectsStackingRulesBaseResponseBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagementProjectsStackingRulesBaseResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagementProjectsStackingRulesBaseResponseBody is not found in the empty JSON string", ManagementProjectsStackingRulesBaseResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagementProjectsStackingRulesBaseResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagementProjectsStackingRulesBaseResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ManagementProjectsStackingRulesBaseResponseBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsStackingRulesBaseResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsStackingRulesBaseResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsStackingRulesBaseResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsStackingRulesBaseResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsStackingRulesBaseResponseBody>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsStackingRulesBaseResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagementProjectsStackingRulesBaseResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsStackingRulesBaseResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsStackingRulesBaseResponseBody
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsStackingRulesBaseResponseBody
  */
  public static ManagementProjectsStackingRulesBaseResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsStackingRulesBaseResponseBody.class);
  }

 /**
  * Convert an instance of ManagementProjectsStackingRulesBaseResponseBody to an JSON string
  *
  * @return JSON string
  */
