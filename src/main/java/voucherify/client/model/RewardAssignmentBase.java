...
public class RewardAssignmentBase {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, rewardId, createdAt, updatedAt, _object, relatedObjectId, relatedObjectType);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to RewardAssignmentBase
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RewardAssignmentBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RewardAssignmentBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RewardAssignmentBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
