...
public class ParameterFiltersListBinResourceId {
  ...
  **/
  ...
  public ParameterFiltersListBinResourceId junction(Junction junction) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conditions, parameterFiltersListBinResourceId.conditions) &&
        Objects.equals(this.junction, parameterFiltersListBinResourceId.junction);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ParameterFiltersListBinResourceId
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterFiltersListBinResourceId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ParameterFiltersListBinResourceId is not found in the empty JSON string", ParameterFiltersListBinResourceId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParameterFiltersListBinResourceId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParameterFiltersListBinResourceId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
