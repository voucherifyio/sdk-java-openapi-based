...
public class ListPublicationsItemBase {
  ...
  public ListPublicationsItemBase() {
  }

  public ListPublicationsItemBase id(String id) {
  ...
  **/
  ...
  public ListPublicationsItemBase _object(ObjectEnum _object) {
  ...
  **/
  ...
  public ListPublicationsItemBase createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ListPublicationsItemBase customerId(String customerId) {
  ...
  **/
  ...
  public ListPublicationsItemBase trackingId(String trackingId) {
  ...
  **/
  ...
  public ListPublicationsItemBase channel(String channel) {
  ...
  **/
  ...
  public ListPublicationsItemBase sourceId(String sourceId) {
  ...
  **/
  ...
  public ListPublicationsItemBase customer(CustomerWithSummaryLoyaltyReferrals customer) {
  ...
  **/
  ...
  public ListPublicationsItemBase addVouchersIdItem(String vouchersIdItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ListPublicationsItemBase listPublicationsItemBase = (ListPublicationsItemBase) o;
    return Objects.equals(this.id, listPublicationsItemBase.id) &&
        Objects.equals(this._object, listPublicationsItemBase._object) &&
        Objects.equals(this.createdAt, listPublicationsItemBase.createdAt) &&
        Objects.equals(this.customerId, listPublicationsItemBase.customerId) &&
        Objects.equals(this.trackingId, listPublicationsItemBase.trackingId) &&
        Objects.equals(this.metadata, listPublicationsItemBase.metadata) &&
  ...
  public String toString() {
    ...
    sb.append("class ListPublicationsItemBase {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ListPublicationsItemBase
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPublicationsItemBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPublicationsItemBase is not found in the empty JSON string", ListPublicationsItemBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPublicationsItemBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPublicationsItemBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPublicationsItemBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPublicationsItemBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPublicationsItemBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPublicationsItemBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPublicationsItemBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPublicationsItemBase>() {
           @Override
           public void write(JsonWriter out, ListPublicationsItemBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPublicationsItemBase read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListPublicationsItemBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListPublicationsItemBase
  * @throws IOException if the JSON string is invalid with respect to ListPublicationsItemBase
  */
  public static ListPublicationsItemBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPublicationsItemBase.class);
  }

 /**
  * Convert an instance of ListPublicationsItemBase to an JSON string
  *
  * @return JSON string
  */
