...
import voucherify.client.model.ParameterFiltersListCustomerRedeemablesCampaignId;
import voucherify.client.model.ParameterFiltersListCustomerRedeemablesCampaignType;
import voucherify.client.model.ParameterFiltersListCustomerRedeemablesCreatedAt;
import voucherify.client.model.ParameterFiltersListCustomerRedeemablesHolderRole;
import voucherify.client.model.ParameterFiltersListCustomerRedeemablesId;
import voucherify.client.model.ParameterFiltersListCustomerRedeemablesRedeemableId;
import voucherify.client.model.ParameterFiltersListCustomerRedeemablesRedeemableObject;
import voucherify.client.model.ParameterFiltersListCustomerRedeemablesVoucherType;
...
public class ParameterFiltersListCustomerRedeemables {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ParameterFiltersListCustomerRedeemables
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterFiltersListCustomerRedeemables.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ParameterFiltersListCustomerRedeemables is not found in the empty JSON string", ParameterFiltersListCustomerRedeemables.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParameterFiltersListCustomerRedeemables.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParameterFiltersListCustomerRedeemables` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("redeemable_id") != null && !jsonObj.get("redeemable_id").isJsonNull()) {
        ParameterFiltersListCustomerRedeemablesRedeemableId.validateJsonElement(jsonObj.get("redeemable_id"));
      }
      // validate the optional field `redeemable_object`
      if (jsonObj.get("redeemable_object") != null && !jsonObj.get("redeemable_object").isJsonNull()) {
        ParameterFiltersListCustomerRedeemablesRedeemableObject.validateJsonElement(jsonObj.get("redeemable_object"));
      }
      // validate the optional field `holder_role`
      if (jsonObj.get("holder_role") != null && !jsonObj.get("holder_role").isJsonNull()) {
        ParameterFiltersListCustomerRedeemablesHolderRole.validateJsonElement(jsonObj.get("holder_role"));
      }
      // validate the optional field `campaign_id`
      if (jsonObj.get("campaign_id") != null && !jsonObj.get("campaign_id").isJsonNull()) {
        ParameterFiltersListCustomerRedeemablesCampaignId.validateJsonElement(jsonObj.get("campaign_id"));
      }
      // validate the optional field `campaign_type`
      if (jsonObj.get("campaign_type") != null && !jsonObj.get("campaign_type").isJsonNull()) {
        ParameterFiltersListCustomerRedeemablesCampaignType.validateJsonElement(jsonObj.get("campaign_type"));
      }
      // validate the optional field `voucher_type`
      if (jsonObj.get("voucher_type") != null && !jsonObj.get("voucher_type").isJsonNull()) {
        ParameterFiltersListCustomerRedeemablesVoucherType.validateJsonElement(jsonObj.get("voucher_type"));
      }
  }
