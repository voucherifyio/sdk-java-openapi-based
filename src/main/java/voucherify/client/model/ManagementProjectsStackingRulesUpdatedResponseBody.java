...
public class ManagementProjectsStackingRulesUpdatedResponseBody {
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody() {
  }

  public ManagementProjectsStackingRulesUpdatedResponseBody id(String id) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody exclusiveCategories(List<String> exclusiveCategories) {
    
    this.exclusiveCategories = exclusiveCategories;
    return this;
  }

  public ManagementProjectsStackingRulesUpdatedResponseBody addExclusiveCategoriesItem(String exclusiveCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody jointCategories(List<String> jointCategories) {
    
    this.jointCategories = jointCategories;
    return this;
  }

  public ManagementProjectsStackingRulesUpdatedResponseBody addJointCategoriesItem(String jointCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody redeemablesLimit(Integer redeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody applicableRedeemablesLimit(Integer applicableRedeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody applicableRedeemablesPerCategoryLimit(Integer applicableRedeemablesPerCategoryLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody applicableExclusiveRedeemablesLimit(Integer applicableExclusiveRedeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody applicableExclusiveRedeemablesPerCategoryLimit(Integer applicableExclusiveRedeemablesPerCategoryLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody discountCalculationMode(DiscountCalculationModeEnum discountCalculationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody initialAmountModeCategories(List<String> initialAmountModeCategories) {
    
    this.initialAmountModeCategories = initialAmountModeCategories;
    return this;
  }

  public ManagementProjectsStackingRulesUpdatedResponseBody addInitialAmountModeCategoriesItem(String initialAmountModeCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody discountedAmountModeCategories(List<String> discountedAmountModeCategories) {
    
    this.discountedAmountModeCategories = discountedAmountModeCategories;
    return this;
  }

  public ManagementProjectsStackingRulesUpdatedResponseBody addDiscountedAmountModeCategoriesItem(String discountedAmountModeCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody redeemablesApplicationMode(RedeemablesApplicationModeEnum redeemablesApplicationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody redeemablesSortingRule(RedeemablesSortingRuleEnum redeemablesSortingRule) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesUpdatedResponseBody updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsStackingRulesUpdatedResponseBody managementProjectsStackingRulesUpdatedResponseBody = (ManagementProjectsStackingRulesUpdatedResponseBody) o;
    return Objects.equals(this.id, managementProjectsStackingRulesUpdatedResponseBody.id) &&
        Objects.equals(this.exclusiveCategories, managementProjectsStackingRulesUpdatedResponseBody.exclusiveCategories) &&
        Objects.equals(this.jointCategories, managementProjectsStackingRulesUpdatedResponseBody.jointCategories) &&
        Objects.equals(this.redeemablesLimit, managementProjectsStackingRulesUpdatedResponseBody.redeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesLimit, managementProjectsStackingRulesUpdatedResponseBody.applicableRedeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesPerCategoryLimit, managementProjectsStackingRulesUpdatedResponseBody.applicableRedeemablesPerCategoryLimit) &&
        Objects.equals(this.applicableExclusiveRedeemablesLimit, managementProjectsStackingRulesUpdatedResponseBody.applicableExclusiveRedeemablesLimit) &&
        Objects.equals(this.applicableExclusiveRedeemablesPerCategoryLimit, managementProjectsStackingRulesUpdatedResponseBody.applicableExclusiveRedeemablesPerCategoryLimit) &&
        Objects.equals(this.discountCalculationMode, managementProjectsStackingRulesUpdatedResponseBody.discountCalculationMode) &&
        Objects.equals(this.initialAmountModeCategories, managementProjectsStackingRulesUpdatedResponseBody.initialAmountModeCategories) &&
        Objects.equals(this.discountedAmountModeCategories, managementProjectsStackingRulesUpdatedResponseBody.discountedAmountModeCategories) &&
        Objects.equals(this.redeemablesApplicationMode, managementProjectsStackingRulesUpdatedResponseBody.redeemablesApplicationMode) &&
        Objects.equals(this.redeemablesSortingRule, managementProjectsStackingRulesUpdatedResponseBody.redeemablesSortingRule) &&
        Objects.equals(this.createdAt, managementProjectsStackingRulesUpdatedResponseBody.createdAt) &&
        Objects.equals(this.updatedAt, managementProjectsStackingRulesUpdatedResponseBody.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsStackingRulesUpdatedResponseBody {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ManagementProjectsStackingRulesUpdatedResponseBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagementProjectsStackingRulesUpdatedResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagementProjectsStackingRulesUpdatedResponseBody is not found in the empty JSON string", ManagementProjectsStackingRulesUpdatedResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagementProjectsStackingRulesUpdatedResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagementProjectsStackingRulesUpdatedResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ManagementProjectsStackingRulesUpdatedResponseBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsStackingRulesUpdatedResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsStackingRulesUpdatedResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsStackingRulesUpdatedResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsStackingRulesUpdatedResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsStackingRulesUpdatedResponseBody>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsStackingRulesUpdatedResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagementProjectsStackingRulesUpdatedResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsStackingRulesUpdatedResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsStackingRulesUpdatedResponseBody
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsStackingRulesUpdatedResponseBody
  */
  public static ManagementProjectsStackingRulesUpdatedResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsStackingRulesUpdatedResponseBody.class);
  }

 /**
  * Convert an instance of ManagementProjectsStackingRulesUpdatedResponseBody to an JSON string
  *
  * @return JSON string
  */
