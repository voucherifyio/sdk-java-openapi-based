...
public class ManagementProjectsStackingRulesCreateRequestBody {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ManagementProjectsStackingRulesCreateRequestBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagementProjectsStackingRulesCreateRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagementProjectsStackingRulesCreateRequestBody is not found in the empty JSON string", ManagementProjectsStackingRulesCreateRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagementProjectsStackingRulesCreateRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagementProjectsStackingRulesCreateRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
