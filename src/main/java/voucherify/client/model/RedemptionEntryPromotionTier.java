...
public class RedemptionEntryPromotionTier {
  ...
  * @throws IOException if the JSON Element is invalid with respect to RedemptionEntryPromotionTier
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("action") != null && !jsonObj.get("action").isJsonNull()) {
        RedemptionEntryPromotionTierAction.validateJsonElement(jsonObj.get("action"));
      }
      ...
      if (jsonObj.get("campaign") != null && !jsonObj.get("campaign").isJsonNull()) {
        RedemptionEntryPromotionTierCampaign.validateJsonElement(jsonObj.get("campaign"));
      }
      ...
      if (jsonObj.get("summary") != null && !jsonObj.get("summary").isJsonNull()) {
        RedemptionEntryPromotionTierSummary.validateJsonElement(jsonObj.get("summary"));
      }
