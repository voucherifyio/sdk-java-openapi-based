...
public class CustomersCreateRequestBody {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CustomersCreateRequestBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomersCreateRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomersCreateRequestBody is not found in the empty JSON string", CustomersCreateRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomersCreateRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomersCreateRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
