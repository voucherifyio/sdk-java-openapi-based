...
public class Cockpit2 {
  ...
  public Cockpit2 campaignsOverviewEnabled(Boolean campaignsOverviewEnabled) {
  ...
  **/
  ...
  public Cockpit2 loyaltyEnabled(Boolean loyaltyEnabled) {
  ...
  **/
  ...
  public Cockpit2 giftCardsEnabled(Boolean giftCardsEnabled) {
  ...
  **/
  ...
  public Cockpit2 couponsEnabled(Boolean couponsEnabled) {
  ...
  **/
  ...
  public Cockpit2 referralsEnabled(Boolean referralsEnabled) {
  ...
  **/
  ...
  public Cockpit2 luckyDrawEnabled(Boolean luckyDrawEnabled) {
  ...
  **/
  ...
  public Cockpit2 theme(ThemeEnum theme) {
  ...
  **/
  ...
  public Cockpit2 useCustomDoubleOptInRedirectUrl(Boolean useCustomDoubleOptInRedirectUrl) {
  ...
  **/
  ...
  public Cockpit2 customDoubleOptInRedirectUrl(String customDoubleOptInRedirectUrl) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Cockpit2 cockpit2 = (Cockpit2) o;
    return Objects.equals(this.campaignsOverviewEnabled, cockpit2.campaignsOverviewEnabled) &&
        Objects.equals(this.loyaltyEnabled, cockpit2.loyaltyEnabled) &&
        Objects.equals(this.giftCardsEnabled, cockpit2.giftCardsEnabled) &&
        Objects.equals(this.couponsEnabled, cockpit2.couponsEnabled) &&
        Objects.equals(this.referralsEnabled, cockpit2.referralsEnabled) &&
        Objects.equals(this.luckyDrawEnabled, cockpit2.luckyDrawEnabled) &&
        Objects.equals(this.theme, cockpit2.theme) &&
        Objects.equals(this.useCustomDoubleOptInRedirectUrl, cockpit2.useCustomDoubleOptInRedirectUrl) &&
        Objects.equals(this.customDoubleOptInRedirectUrl, cockpit2.customDoubleOptInRedirectUrl);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("campaigns_overview_enabled");
    openapiRequiredFields.add("loyalty_enabled");
    openapiRequiredFields.add("gift_cards_enabled");
    openapiRequiredFields.add("coupons_enabled");
    openapiRequiredFields.add("referrals_enabled");
    openapiRequiredFields.add("lucky_draw_enabled");
    openapiRequiredFields.add("theme");
    openapiRequiredFields.add("use_custom_double_opt_in_redirect_url");
    openapiRequiredFields.add("custom_double_opt_in_redirect_url");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to Cockpit2
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cockpit2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cockpit2 is not found in the empty JSON string", Cockpit2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cockpit2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cockpit2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Cockpit2.openapiRequiredFields) {
      ...
      if (!jsonObj.get("custom_double_opt_in_redirect_url").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cockpit2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cockpit2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cockpit2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cockpit2.class));

       return (TypeAdapter<T>) new TypeAdapter<Cockpit2>() {
           @Override
           public void write(JsonWriter out, Cockpit2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cockpit2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Cockpit2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Cockpit2
  * @throws IOException if the JSON string is invalid with respect to Cockpit2
  */
  public static Cockpit2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cockpit2.class);
  }

 /**
  * Convert an instance of Cockpit2 to an JSON string
  *
  * @return JSON string
  */
