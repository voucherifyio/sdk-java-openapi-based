...
public class LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode {
  ...
  * @throws IOException if the JSON Element is invalid with respect to LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode is not found in the empty JSON string", LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
