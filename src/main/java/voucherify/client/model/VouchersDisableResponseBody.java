...
public class VouchersDisableResponseBody {
  ...
  **/
  ...
  public VouchersDisableResponseBody validityTimeframe(CampaignsVouchersCreateCombinedResponseBodyValidityTimeframe validityTimeframe) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VouchersDisableResponseBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VouchersDisableResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VouchersDisableResponseBody is not found in the empty JSON string", VouchersDisableResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VouchersDisableResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VouchersDisableResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
