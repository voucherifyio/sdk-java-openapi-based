...
import voucherify.client.model.ReferralCampaignVoucher;
...
public class CampaignsCreateReferralCampaign {
  ...
  private ReferralCampaignVoucher voucher;

  public CampaignsCreateReferralCampaign() {
  }

  public CampaignsCreateReferralCampaign name(String name) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign description(String description) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign type(TypeEnum type) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign joinOnce(Boolean joinOnce) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign autoJoin(Boolean autoJoin) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign useVoucherMetadataSchema(Boolean useVoucherMetadataSchema) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign vouchersCount(Integer vouchersCount) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign expirationDate(OffsetDateTime expirationDate) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign validityTimeframe(CampaignBaseValidityTimeframe validityTimeframe) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign validityDayOfWeek(List<ValidityDayOfWeekEnum> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public CampaignsCreateReferralCampaign addValidityDayOfWeekItem(ValidityDayOfWeekEnum validityDayOfWeekItem) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign validityHours(ValidityHours validityHours) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign activityDurationAfterPublishing(String activityDurationAfterPublishing) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign validationRules(List<String> validationRules) {
    
    this.validationRules = validationRules;
    return this;
  }

  public CampaignsCreateReferralCampaign addValidationRulesItem(String validationRulesItem) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign categoryId(String categoryId) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign category(String category) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign metadata(Object metadata) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign campaignType(CampaignTypeEnum campaignType) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign referralProgram(ReferralProgram referralProgram) {
  ...
  **/
  ...
  public CampaignsCreateReferralCampaign voucher(ReferralCampaignVoucher voucher) {
  ...
  **/
  @javax.annotation.Nullable
  public ReferralCampaignVoucher getVoucher() {
    return voucher;
  }


  public void setVoucher(ReferralCampaignVoucher voucher) {
    this.voucher = voucher;
  }
  ...
  public boolean equals(Object o) {
    ...
    CampaignsCreateReferralCampaign campaignsCreateReferralCampaign = (CampaignsCreateReferralCampaign) o;
    return Objects.equals(this.name, campaignsCreateReferralCampaign.name) &&
        Objects.equals(this.description, campaignsCreateReferralCampaign.description) &&
        Objects.equals(this.type, campaignsCreateReferralCampaign.type) &&
        Objects.equals(this.joinOnce, campaignsCreateReferralCampaign.joinOnce) &&
        Objects.equals(this.autoJoin, campaignsCreateReferralCampaign.autoJoin) &&
        Objects.equals(this.useVoucherMetadataSchema, campaignsCreateReferralCampaign.useVoucherMetadataSchema) &&
        Objects.equals(this.vouchersCount, campaignsCreateReferralCampaign.vouchersCount) &&
        Objects.equals(this.startDate, campaignsCreateReferralCampaign.startDate) &&
        Objects.equals(this.expirationDate, campaignsCreateReferralCampaign.expirationDate) &&
        Objects.equals(this.validityTimeframe, campaignsCreateReferralCampaign.validityTimeframe) &&
        Objects.equals(this.validityDayOfWeek, campaignsCreateReferralCampaign.validityDayOfWeek) &&
        Objects.equals(this.validityHours, campaignsCreateReferralCampaign.validityHours) &&
        Objects.equals(this.activityDurationAfterPublishing, campaignsCreateReferralCampaign.activityDurationAfterPublishing) &&
        Objects.equals(this.validationRules, campaignsCreateReferralCampaign.validationRules) &&
        Objects.equals(this.categoryId, campaignsCreateReferralCampaign.categoryId) &&
        Objects.equals(this.category, campaignsCreateReferralCampaign.category) &&
        Objects.equals(this.metadata, campaignsCreateReferralCampaign.metadata) &&
        Objects.equals(this.campaignType, campaignsCreateReferralCampaign.campaignType) &&
        Objects.equals(this.referralProgram, campaignsCreateReferralCampaign.referralProgram) &&
        Objects.equals(this.voucher, campaignsCreateReferralCampaign.voucher);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, type, joinOnce, autoJoin, useVoucherMetadataSchema, vouchersCount, startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, activityDurationAfterPublishing, validationRules, categoryId, category, metadata, campaignType, referralProgram, voucher);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CampaignsCreateReferralCampaign {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CampaignsCreateReferralCampaign
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignsCreateReferralCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsCreateReferralCampaign is not found in the empty JSON string", CampaignsCreateReferralCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignsCreateReferralCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignsCreateReferralCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("voucher") != null && !jsonObj.get("voucher").isJsonNull()) {
        ReferralCampaignVoucher.validateJsonElement(jsonObj.get("voucher"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsCreateReferralCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsCreateReferralCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsCreateReferralCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsCreateReferralCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsCreateReferralCampaign>() {
           @Override
           public void write(JsonWriter out, CampaignsCreateReferralCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignsCreateReferralCampaign read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignsCreateReferralCampaign given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsCreateReferralCampaign
  * @throws IOException if the JSON string is invalid with respect to CampaignsCreateReferralCampaign
  */
  public static CampaignsCreateReferralCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsCreateReferralCampaign.class);
  }

 /**
  * Convert an instance of CampaignsCreateReferralCampaign to an JSON string
  *
  * @return JSON string
  */
