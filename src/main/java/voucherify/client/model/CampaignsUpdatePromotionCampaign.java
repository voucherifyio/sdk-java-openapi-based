...
public class CampaignsUpdatePromotionCampaign {
  ...
  public CampaignsUpdatePromotionCampaign() {
  }

  public CampaignsUpdatePromotionCampaign startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public CampaignsUpdatePromotionCampaign expirationDate(OffsetDateTime expirationDate) {
  ...
  **/
  ...
  public CampaignsUpdatePromotionCampaign validityTimeframe(CampaignBaseValidityTimeframe validityTimeframe) {
  ...
  **/
  ...
  public CampaignsUpdatePromotionCampaign validityDayOfWeek(List<ValidityDayOfWeekEnum> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public CampaignsUpdatePromotionCampaign addValidityDayOfWeekItem(ValidityDayOfWeekEnum validityDayOfWeekItem) {
  ...
  **/
  ...
  public CampaignsUpdatePromotionCampaign validityHours(ValidityHours validityHours) {
  ...
  **/
  ...
  public CampaignsUpdatePromotionCampaign description(String description) {
  ...
  **/
  ...
  public CampaignsUpdatePromotionCampaign category(String category) {
  ...
  **/
  ...
  public CampaignsUpdatePromotionCampaign metadata(Object metadata) {
  ...
  **/
  ...
  public CampaignsUpdatePromotionCampaign unsetMetadataFields(List<String> unsetMetadataFields) {
    
    this.unsetMetadataFields = unsetMetadataFields;
    return this;
  }

  public CampaignsUpdatePromotionCampaign addUnsetMetadataFieldsItem(String unsetMetadataFieldsItem) {
  ...
  **/
  ...
  public CampaignsUpdatePromotionCampaign categoryId(String categoryId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampaignsUpdatePromotionCampaign campaignsUpdatePromotionCampaign = (CampaignsUpdatePromotionCampaign) o;
    return Objects.equals(this.startDate, campaignsUpdatePromotionCampaign.startDate) &&
        Objects.equals(this.expirationDate, campaignsUpdatePromotionCampaign.expirationDate) &&
        Objects.equals(this.validityTimeframe, campaignsUpdatePromotionCampaign.validityTimeframe) &&
        Objects.equals(this.validityDayOfWeek, campaignsUpdatePromotionCampaign.validityDayOfWeek) &&
        Objects.equals(this.validityHours, campaignsUpdatePromotionCampaign.validityHours) &&
        Objects.equals(this.description, campaignsUpdatePromotionCampaign.description) &&
        Objects.equals(this.category, campaignsUpdatePromotionCampaign.category) &&
        Objects.equals(this.metadata, campaignsUpdatePromotionCampaign.metadata) &&
        Objects.equals(this.unsetMetadataFields, campaignsUpdatePromotionCampaign.unsetMetadataFields) &&
        Objects.equals(this.categoryId, campaignsUpdatePromotionCampaign.categoryId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, description, category, metadata, unsetMetadataFields, categoryId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsUpdatePromotionCampaign {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CampaignsUpdatePromotionCampaign
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignsUpdatePromotionCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsUpdatePromotionCampaign is not found in the empty JSON string", CampaignsUpdatePromotionCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignsUpdatePromotionCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignsUpdatePromotionCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsUpdatePromotionCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsUpdatePromotionCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsUpdatePromotionCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsUpdatePromotionCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsUpdatePromotionCampaign>() {
           @Override
           public void write(JsonWriter out, CampaignsUpdatePromotionCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignsUpdatePromotionCampaign read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignsUpdatePromotionCampaign given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsUpdatePromotionCampaign
  * @throws IOException if the JSON string is invalid with respect to CampaignsUpdatePromotionCampaign
  */
  public static CampaignsUpdatePromotionCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsUpdatePromotionCampaign.class);
  }

 /**
  * Convert an instance of CampaignsUpdatePromotionCampaign to an JSON string
  *
  * @return JSON string
  */
