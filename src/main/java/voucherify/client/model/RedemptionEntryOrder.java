...
public class RedemptionEntryOrder {
  ...
  * @throws IOException if the JSON Element is invalid with respect to RedemptionEntryOrder
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("customer") != null && !jsonObj.get("customer").isJsonNull()) {
        RedemptionEntryOrderCustomer.validateJsonElement(jsonObj.get("customer"));
      }
      // validate the optional field `referrer`
      if (jsonObj.get("referrer") != null && !jsonObj.get("referrer").isJsonNull()) {
        RedemptionEntryOrderReferrer.validateJsonElement(jsonObj.get("referrer"));
      }
  }
