...
import voucherify.client.model.RedemptionsGetResponseBodyVoucherValidityTimeframe;
...
public class RedemptionsGetResponseBodyVoucher {
  ...
  private RedemptionsGetResponseBodyVoucherValidityTimeframe validityTimeframe;
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher validityTimeframe(RedemptionsGetResponseBodyVoucherValidityTimeframe validityTimeframe) {
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionsGetResponseBodyVoucherValidityTimeframe getValidityTimeframe() {
    return validityTimeframe;
  }


  public void setValidityTimeframe(RedemptionsGetResponseBodyVoucherValidityTimeframe validityTimeframe) {
    this.validityTimeframe = validityTimeframe;
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to RedemptionsGetResponseBodyVoucher
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedemptionsGetResponseBodyVoucher.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedemptionsGetResponseBodyVoucher is not found in the empty JSON string", RedemptionsGetResponseBodyVoucher.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedemptionsGetResponseBodyVoucher.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedemptionsGetResponseBodyVoucher` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("gift") != null && !jsonObj.get("gift").isJsonNull()) {
        RedemptionsGetResponseBodyVoucherGift.validateJsonElement(jsonObj.get("gift"));
      }
      // validate the optional field `loyalty_card`
      if (jsonObj.get("loyalty_card") != null && !jsonObj.get("loyalty_card").isJsonNull()) {
        RedemptionsGetResponseBodyVoucherLoyaltyCard.validateJsonElement(jsonObj.get("loyalty_card"));
      }
      ...
      if (jsonObj.get("validity_timeframe") != null && !jsonObj.get("validity_timeframe").isJsonNull()) {
        RedemptionsGetResponseBodyVoucherValidityTimeframe.validateJsonElement(jsonObj.get("validity_timeframe"));
      }
      ...
      if (jsonObj.get("publish") != null && !jsonObj.get("publish").isJsonNull()) {
        RedemptionsGetResponseBodyVoucherPublish.validateJsonElement(jsonObj.get("publish"));
      }
      // validate the optional field `redemption`
      if (jsonObj.get("redemption") != null && !jsonObj.get("redemption").isJsonNull()) {
        RedemptionsGetResponseBodyVoucherRedemption.validateJsonElement(jsonObj.get("redemption"));
      }
