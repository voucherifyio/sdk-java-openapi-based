...
public class CampaignsCreateGiveawayCampaign {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign validityDayOfWeek(List<Integer> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public CampaignsCreateGiveawayCampaign addValidityDayOfWeekItem(Integer validityDayOfWeekItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, type, joinOnce, autoJoin, useVoucherMetadataSchema, vouchersCount, startDate, expirationDate, validityTimeframe, validityDayOfWeek, activityDurationAfterPublishing, validationRules, categoryId, category, metadata, campaignType, voucher, luckyDraw);
  }
