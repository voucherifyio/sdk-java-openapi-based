...
public class CampaignsCreateGiveawayCampaign {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign description(String description) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign type(TypeEnum type) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign joinOnce(Boolean joinOnce) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign autoJoin(Boolean autoJoin) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign useVoucherMetadataSchema(Boolean useVoucherMetadataSchema) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign vouchersCount(Integer vouchersCount) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign expirationDate(OffsetDateTime expirationDate) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign validityTimeframe(CampaignBaseValidityTimeframe validityTimeframe) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign validityDayOfWeek(List<ValidityDayOfWeekEnum> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public CampaignsCreateGiveawayCampaign addValidityDayOfWeekItem(ValidityDayOfWeekEnum validityDayOfWeekItem) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign validityHours(ValidityHours validityHours) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign activityDurationAfterPublishing(String activityDurationAfterPublishing) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign validationRules(List<String> validationRules) {
    
    this.validationRules = validationRules;
    return this;
  }

  public CampaignsCreateGiveawayCampaign addValidationRulesItem(String validationRulesItem) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign categoryId(String categoryId) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign category(String category) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign metadata(Object metadata) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign campaignType(CampaignTypeEnum campaignType) {
  ...
  **/
  ...
  public CampaignsCreateGiveawayCampaign voucher(GiveawayCampaignVoucher voucher) {
  ...
  **/
  @javax.annotation.Nullable
  public GiveawayCampaignVoucher getVoucher() {
    return voucher;
  }


  public void setVoucher(GiveawayCampaignVoucher voucher) {
    this.voucher = voucher;
  }


  public CampaignsCreateGiveawayCampaign luckyDraw(LuckyDraw luckyDraw) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampaignsCreateGiveawayCampaign campaignsCreateGiveawayCampaign = (CampaignsCreateGiveawayCampaign) o;
    return Objects.equals(this.name, campaignsCreateGiveawayCampaign.name) &&
        Objects.equals(this.description, campaignsCreateGiveawayCampaign.description) &&
        Objects.equals(this.type, campaignsCreateGiveawayCampaign.type) &&
        Objects.equals(this.joinOnce, campaignsCreateGiveawayCampaign.joinOnce) &&
        Objects.equals(this.autoJoin, campaignsCreateGiveawayCampaign.autoJoin) &&
        Objects.equals(this.useVoucherMetadataSchema, campaignsCreateGiveawayCampaign.useVoucherMetadataSchema) &&
        Objects.equals(this.vouchersCount, campaignsCreateGiveawayCampaign.vouchersCount) &&
        Objects.equals(this.startDate, campaignsCreateGiveawayCampaign.startDate) &&
        Objects.equals(this.expirationDate, campaignsCreateGiveawayCampaign.expirationDate) &&
        Objects.equals(this.validityTimeframe, campaignsCreateGiveawayCampaign.validityTimeframe) &&
        Objects.equals(this.validityDayOfWeek, campaignsCreateGiveawayCampaign.validityDayOfWeek) &&
        Objects.equals(this.validityHours, campaignsCreateGiveawayCampaign.validityHours) &&
        Objects.equals(this.activityDurationAfterPublishing, campaignsCreateGiveawayCampaign.activityDurationAfterPublishing) &&
        Objects.equals(this.validationRules, campaignsCreateGiveawayCampaign.validationRules) &&
        Objects.equals(this.categoryId, campaignsCreateGiveawayCampaign.categoryId) &&
        Objects.equals(this.category, campaignsCreateGiveawayCampaign.category) &&
        Objects.equals(this.metadata, campaignsCreateGiveawayCampaign.metadata) &&
        Objects.equals(this.campaignType, campaignsCreateGiveawayCampaign.campaignType) &&
        Objects.equals(this.voucher, campaignsCreateGiveawayCampaign.voucher) &&
        Objects.equals(this.luckyDraw, campaignsCreateGiveawayCampaign.luckyDraw);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, type, joinOnce, autoJoin, useVoucherMetadataSchema, vouchersCount, startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, activityDurationAfterPublishing, validationRules, categoryId, category, metadata, campaignType, voucher, luckyDraw);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CampaignsCreateGiveawayCampaign {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CampaignsCreateGiveawayCampaign
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignsCreateGiveawayCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsCreateGiveawayCampaign is not found in the empty JSON string", CampaignsCreateGiveawayCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignsCreateGiveawayCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignsCreateGiveawayCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("voucher") != null && !jsonObj.get("voucher").isJsonNull()) {
        GiveawayCampaignVoucher.validateJsonElement(jsonObj.get("voucher"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsCreateGiveawayCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsCreateGiveawayCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsCreateGiveawayCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsCreateGiveawayCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsCreateGiveawayCampaign>() {
           @Override
           public void write(JsonWriter out, CampaignsCreateGiveawayCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignsCreateGiveawayCampaign read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignsCreateGiveawayCampaign given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsCreateGiveawayCampaign
  * @throws IOException if the JSON string is invalid with respect to CampaignsCreateGiveawayCampaign
  */
  public static CampaignsCreateGiveawayCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsCreateGiveawayCampaign.class);
  }

 /**
  * Convert an instance of CampaignsCreateGiveawayCampaign to an JSON string
  *
  * @return JSON string
  */
