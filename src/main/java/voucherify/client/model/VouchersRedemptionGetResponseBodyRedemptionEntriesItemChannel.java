...
public class VouchersRedemptionGetResponseBodyRedemptionEntriesItemChannel {
  ...
  **/
   ...
   * @return the VouchersRedemptionGetResponseBodyRedemptionEntriesItemChannel instance itself
   */
  public VouchersRedemptionGetResponseBodyRedemptionEntriesItemChannel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VouchersRedemptionGetResponseBodyRedemptionEntriesItemChannel>() {
           ...
           public VouchersRedemptionGetResponseBodyRedemptionEntriesItemChannel read(JsonReader in) throws IOException {
             ...
             VouchersRedemptionGetResponseBodyRedemptionEntriesItemChannel instance = thisAdapter.fromJsonTree(jsonObj);
