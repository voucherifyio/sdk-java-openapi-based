...
import voucherify.client.model.ParameterFiltersListBin;
import voucherify.client.model.ParameterOrderListBin;
import voucherify.client.model.TrashBinListResponseBody;
...
public class BinApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns the list of all the bin entries matching the query parameters. </td><td>  -  </td></tr>
     </table>
     */
